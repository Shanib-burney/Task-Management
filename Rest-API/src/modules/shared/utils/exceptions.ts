...
export class UnprocessableEntityException extends HttpException {
  constructor(message = 'Validation Failed', details?: any) {
    super(message, HTTP_STATUS_CODE.UNPROCESSABLE_ENTITY, 'UNPROCESSABLE_ENTITY', details);
  }
}
...
export class TooManyRequestsException extends HttpException {
  constructor(message = 'Too Many Requests') {
    super(message, HTTP_STATUS_CODE.TOO_MANY_REQUESTS, 'TOO_MANY_REQUESTS');
  }
}
...
export class InternalServerException extends HttpException {
  constructor(message = 'Internal Server Error') {
    super(message, HTTP_STATUS_CODE.INTERNAL_SERVER_ERROR, 'INTERNAL_SERVER_ERROR');
  }
}
...
export class ServiceUnavailableException extends HttpException {
  constructor(message = 'Service Unavailable') {
    super(message, HTTP_STATUS_CODE.SERVICE_UNAVAILABLE, 'SERVICE_UNAVAILABLE');
  }
}
